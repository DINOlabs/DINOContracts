...
contract DINOToken is Context, IBEP20, Ownable {
    ...
    string private constant _name = 'DinoYield.finance';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D, 'router.');
